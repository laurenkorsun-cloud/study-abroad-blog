    ...
    <div className="flex flex-col bg-white">
      ...
      <section className="relative overflow-hidden bg-white">
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center select-none">
          <span
            className="font-title text-[clamp(14rem,40vw,28rem)] font-bold leading-none tracking-tighter text-slate-200/50"
            aria-hidden="true"
          >
            {header.watermark}
          </span>
        ...
        <div className="section-container relative z-10 flex min-h-[min(85vh,52rem)] flex-col items-center justify-center px-6 pt-20 pb-16 text-center md:px-10 md:pt-24 md:pb-20">
          <div className="space-y-6 md:space-y-8">
            ...
            <h1 className="font-title text-[clamp(2.25rem,8vw,4.5rem)] font-bold uppercase leading-[0.95] tracking-tight text-slate-900">
              {header.title}
            </h1>
          </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_320px]">
          <div>
            <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
              <h2 className="font-title text-sm font-semibold uppercase tracking-[0.2em] text-slate-900">
          ...
          <aside className="space-y-5 lg:sticky lg:top-24 lg:self-start">
            ...
            <div className="space-y-3 rounded-sm border border-slate-200/80 bg-white p-4 shadow-sm">
              <div className="flex items-center justify-between gap-2">
                <h2 className="font-title text-sm font-semibold">{romeSidebar.videoTitle}</h2>
        ...
        <div className="space-y-5">
          <div className="flex flex-col justify-between gap-3 md:flex-row md:items-end">
            <div className="space-y-2">
              <h2 className="font-title text-base font-semibold text-slate-900">{romeMapSection.title}</h2>
